...
public class utilTablasSocio {
    ...
    public void dibujarTablaSocios(vSocios vS) {
        ...
        vSocio.modeloTablaSocios.getColumnModel().getColumn(1).setPreferredWidth(240);
        vSocio.modeloTablaSocios.getColumnModel().getColumn(2).setPreferredWidth(100);
        vSocio.modeloTablaSocios.getColumnModel().getColumn(3).setPreferredWidth(150);
        vSocio.modeloTablaSocios.getColumnModel().getColumn(4).setPreferredWidth(100);
        vSocio.modeloTablaSocios.getColumnModel().getColumn(5).setPreferredWidth(170);
        vSocio.modeloTablaSocios.getColumnModel().getColumn(6).setPreferredWidth(150);
