...
public class Actividad implements Serializable {
    ...
    public Actividad(String idactividad, String nombre,Integer preciobasemes) {
        this.idactividad = idactividad;
        this.nombre = nombre;
        this.preciobasemes = preciobasemes;
    }

    public Actividad(String idactividad, String nombre, String descripcion, Integer preciobasemes, Monitor monitorresponsable) {
        this.idactividad = idactividad;
        this.nombre = nombre;
