...
public class Monitor implements Serializable {
    ...
    private Set<Actividad> actividadesResponsables=new HashSet<Actividad>();
    ...
    public Set<Actividad> getActividadSet() {
        return actividadesResponsables;
    }

    public void setActividadSet(Set<Actividad> actividadSet) {
        this.actividadesResponsables = actividadSet;
    }
    ...
    public String toString() {
        return "Monitor{" + "codmonitor=" + codmonitor + ", nombre=" + nombre + ", dni=" + dni + ", telefono=" + telefono + ", correo=" + correo + ", fechaentrada=" + fechaentrada + ", nick=" + nick + '}';
    }
